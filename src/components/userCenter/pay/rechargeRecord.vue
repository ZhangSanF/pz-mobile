          ...
          <div>
              <ul class="card-box" v-if="curData.length > 0">
                  <li class="list" v-for="(item, index) in curData" :key="index">
                      ...
                      <div class="item">
                          <span class="title">充值账号<span class="info">{{item.username}}</span></span>                          
                      </div>
                      <div class="item">
                          <span class="title">充值金额<span class="info g-info money">{{item.trueamount}}</span></span>                          
                      </div>
                      <div class="item">
